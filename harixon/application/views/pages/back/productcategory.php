				...
				<tbody>
					...
					if(!empty($productcategory)){
						foreach($productcategory as $key => $value){
							...
							echo '<td><a href="' . base_url('backmanage/productcategoryedit?id=' . $value['id']) . '">编辑</a>|<a href="javascript:void(0)" class="J-del" value="' . $value['id'] . '">删除</a></td>';
						}
					}
				?>
				</tbody>
...
<script>
	...
	$('.J-del').click(function(){
		var id = $(this).attr('value'),
			url = domain + 'backmanage/delproductcategory';
		var param = {
			'id':id
		}
		sconfirm('确认删除该条产品分组？',function(){
	...
	$('#J-add').click(function(){
		location.href = domain + 'backmanage/productcategoryedit';
	});
</script>