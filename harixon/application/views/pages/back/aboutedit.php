            ...
            <form role="form" onsubmit="return false">
                <div class="form-group">
                    ...
                    <textarea name="content" id="editor">
                        <?php echo !empty($aboutinfo) ? $aboutinfo['content'] : ''?>
                    </textarea>
                </div>           
            </form>
        </div>
...
<script>
    var editor = CKEDITOR.replace( 'editor' ,{
        filebrowserImageUploadUrl : domain + '/backmanage/uploadaboutimg?responseType=json',
        height:600,
    });

    $('#J-save').click(function(){
        var content = CKEDITOR.instances.editor.getData(),
            url = domain + 'backmanage/changeabout';
        var param = {
            'content':content,
        };
